    ...
    if (str.next()){
    	 ResultSet str1;
    	    ...
    	    if (str1.next()) { //goes through each username and password and compares with the given username and passwprd
    	        ...
    	        out.println("Invalid password: Please Try Again --> <a href='Login.jsp'> Go back to Login Page</a>");
    	    }
    }
    else{
    	out.println("Invalid username: Please Try Again --> <a href='Login.jsp'> Go back to Login Page</a>");
    }
%>
</body>
</html>